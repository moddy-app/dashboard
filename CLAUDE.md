...
| `/servers/:guildId/modules/tickets` | `TicketsPage` | Oui | Module Tickets (panneaux, catégories, vues lecture seule) |
...
*Dernière mise à jour : 2026-09-09 (merge preview → main : Brocoli + écran d'installation et statistiques internes staff)*
