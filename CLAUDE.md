...
| `/servers/:guildId/modules/logs` | `LogsPage` | Oui | Module Logs (événements → salons, ≠ `logging`) |
...
*Dernière mise à jour : 2026-08-23 (intégration du module Logs)*
