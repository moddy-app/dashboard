  ...
  return (
    ...
    <div className="-m-6 flex h-[calc(100%+3rem)] min-h-0 flex-1 flex-col">
      ...
      {/* Écart franc avec le fil : sans lui, la saisie touche le dernier
          message de Brocoli et les deux blocs se lisent comme un seul. Resserré
          sur petit écran, où ces 3 rem se prennent sur le fil lui-même. */}
      <div className="shrink-0 bg-background pt-4 pb-3 sm:pt-8 sm:pb-4">
